...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "next"
    user-mail-address "next@example.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/next/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/next/bin" "/profile/bin" "/Users/next/.npm-packages/bin" "/Users/next/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
